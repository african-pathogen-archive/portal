...
const ProjectsTable: React.FC = () => {
  ...
  return (<>
    ...
    <Title level={4} style={{width: '80%'}}>Your projects</Title>
      <Space direction={'horizontal'} style={{display: 'flex', justifyContent: 'space-between', marginBottom: 20}} >
        <Search placeholder="input search text" allowClear onSearch={()=>{}} style={{ width: 200 }} />
        <div>
          <a style={{marginRight: 10}} href='/'>View all</a>
