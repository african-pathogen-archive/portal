...
const AdministratorDetailsForm = (): ReactElement => {
	...
	return (
		...
		>
			<h2>Your details</h2>
			<Form name="administrator_details" colon={false} layout="vertical">
				<Form.Item
					label="First Name"
					name="first_name"
					rules={[
				...
				>
					<Input value={surname} onChange={updateSurname} />
				</Form.Item>
				<Form.Item
					label="Institution"
					name="institution"
				...
				>
					<Input value={institution} onChange={updateInstitution} />
				</Form.Item>
				<Form.Item
					label="Phone Number"
					name="phone_number"
				...
				>
					<Input value={phoneNumber} onChange={updatePhoneNumber} />
				</Form.Item>
				<Form.Item
					label="Email Address"
					name="email_address"
				...
				>
					<Input value={emailAddress} onChange={updateEmailAddress} />
				</Form.Item>
				<Form.Item
				...
				>
					<Input value={reasonForAccess} onChange={updateReasonForAccess} />
				</Form.Item>
				<Form.Item>
					<Button htmlType="button" type="primary" onClick={navigateToHomePage} size="large">
						Next
					</Button>
				</Form.Item>
			</Form>
